...
layersizes_1 = [64, 32, 16, 8]                                  # hidden layer sizes for the autoencoder, descending in size
layersizes_2 = [128, 64, 32, 16, 8, 4]                          # hidden layer sizes for the larger encoder, descending in size
layersizes_3 = [128, 110, 100, 90, 80, 75, 64, 32, 16, 8, 4]    # hidden layer sizes for the largest encoder, descending in size