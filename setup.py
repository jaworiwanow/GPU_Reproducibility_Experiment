...
SEED = 2110837058
repetitions = 99           # number of repetitions of the experiment
...
layersizes_9 = [64, 32, 16, 8]                                  # hidden layer sizes for the 9 layer autoencoder, descending in size
layersizes_13 = [128, 64, 32, 16, 8, 4]                          # hidden layer sizes for the 13 layer encoder, descending in size
layersizes_23 = [128, 110, 100, 90, 80, 75, 64, 32, 16, 8, 4]    # hidden layer sizes for the 23 layer encoder, descending in size
layersizes_11 = [128, 64, 32, 16, 8]                             # hidden layer sizes for the 11 layer autoencoder, descending in size